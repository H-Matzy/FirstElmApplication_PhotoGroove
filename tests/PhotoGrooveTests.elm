...
import PhotoGallery exposing (Model, Msg(..), Photo, Status(..), initialModel, main, photoDecoder, update, urlPrefix, view)
...
noPhotosNoThumbnails =
    test "No thumby boys render when there are no photographs to render" <|
        \_ ->
            initialModel
                |> PhotoGallery.view
                |> Query.fromHtml
